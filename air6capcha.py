...
def task(phone,api_id,api_hash,botid,tentw,tenmedium,wall,ref):
    ...
    if not Client.is_user_authorized(): 
        ...
        try:
            ...
            Client(JoinChannelRequest("biskitglobal"))
            ...
            Client.send_message(botid, tenmedium)
            # print('3')
            ...
            if not wait(Client,botid,"Optional + 100 PFC"): return False
...
def main():
    ...
    botid = "BisKitAirdropBot"#thay tên
    
    ref = "5098202230"#phải thay ref
    for i in range(190,250,5): #vòng forr này nè. ví dụ m chạy 5 luồng thì nó chạy từ 0,1,2,3,4 là hết 5 cái. nên sau khi chạy xong thì i nó phải tăng thêm 5 tức là i + 5 nên m phải set step cho nó
